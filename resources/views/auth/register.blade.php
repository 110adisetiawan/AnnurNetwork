                ...
                <div class="card p-7">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="index.html" class="app-brand-link gap-3">
                            <span class="app-brand-text demo text-heading fw-semibold">AINNUR NET</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <div class="card-body mt-1">
                        <h4 class="mb-1">Daftar User</h4>
                        <p class="mb-5">Silahkan mengisi form sesuai dengan diri anda</p>
